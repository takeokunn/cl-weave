...
(define-cli-options
  ...
  (:options
   ...
   (:flag "--retry" :kind :value :field :retry :parser parse-retry-option)
   (:flag "--test-timeout-ms" :kind :value :field :test-timeout-ms :parser parse-timeout-ms-option)
   (:flag "--max-workers" :kind :value :field :max-workers :parser parse-max-workers-option)
